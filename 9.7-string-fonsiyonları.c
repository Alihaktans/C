#include <stdio.h>
#include <string.h> //* Stringlerle çalışırken kullanılır.
...
int main(){
   ...
   //strlwr(string1);                       // stringi küçük karakterlre dönüştürür (String Lower)
   //strupr(string1);                       // stringi büyük karakterlre dönüştürür (String Upper)
